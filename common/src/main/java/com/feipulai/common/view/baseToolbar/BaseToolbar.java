...
public class BaseToolbar extends Toolbar {
    ...
    public void setBackButton(@DrawableRes int resId) {
        ...
        mIvBack = createImageMenu(mContext, resId, new View.OnClickListener() {
            @Override
     ...
     * 显示左边图形菜单按钮
     */
    public void addLeftImage(@DrawableRes int resId, View.OnClickListener listener) {
     ...
     * 显示左边文本菜单按钮
     */
    public void addLeftText(CharSequence text, View.OnClickListener listener) {
        TextView textMenu = createTextMenu(mContext, text, mSubTextColorId, listener);
        addLeftView(textMenu);
    }

    public void addLeftText(CharSequence text, @ColorInt int colorId, View.OnClickListener listener) {
        TextView textMenu = createTextMenu(mContext, text, colorId, listener);
        addLeftView(textMenu);
    }

    public void addLeftText(@StringRes int resId, View.OnClickListener listener) {
        addLeftText(getContext().getText(resId), listener);
    }

    public void addLeftText(@StringRes int resId, @ColorInt int colorId, View.OnClickListener listener) {
     ...
     * @param listener
     */
    public void addRightText(CharSequence text, @ColorInt int colorId, View.OnClickListener listener) {
        TextView textMenu = createTextMenu(mContext, text, colorId, listener);
        addRightView(textMenu);
    }

    public void addRightText(CharSequence text, View.OnClickListener listener) {
        TextView textMenu = createTextMenu(mContext, text, mSubTextColorId, listener);
        addRightView(textMenu);
    }

    public void addRightText(@StringRes int text, View.OnClickListener listener) {
        addRightText(getContext().getText(text), listener);
    }

    public void addRightText(@StringRes int text, @ColorInt int colorId, View.OnClickListener listener) {
     ...
     * 显示右边图形菜单按钮
     */
    public void addRightImage(@DrawableRes int resId, View.OnClickListener listener) {
        ImageView imageMenu = createImageMenu(mContext, resId, listener);
        imageMenu.setImageResource(resId);
        imageMenu.setOnClickListener(listener);
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder addLeftImage(@DrawableRes int imgResId, View.OnClickListener listener) {
            if (leftViewList == null) leftViewList = new ArrayList<>();
            leftViewList.add(createImageMenu(mContext, imgResId, listener));
            return this;
        }

        public Builder addRightImage(@DrawableRes int imgResId, View.OnClickListener listener) {
         ...
         * @return
         */
        public Builder addLeftText(CharSequence text, View.OnClickListener listener) {
            if (leftViewList == null) leftViewList = new ArrayList<>();
            leftViewList.add(createTextMenu(mContext, text, subTextColorId, listener));
            return this;
        }

        public Builder addLeftText(CharSequence text, @ColorInt int textColorId, View.OnClickListener listener) {
            if (leftViewList == null) leftViewList = new ArrayList<>();
        ...
        public Builder addLeftText(@StringRes int textResId, View.OnClickListener listener) {
            addLeftText(mContext.getString(textResId), subTextColorId, listener);
            return this;
        }

        public Builder addLeftText(@StringRes int textResId, @ColorInt int textColorId, View.OnClickListener listener) {
         ...
         * @return
         */
        public Builder addRightText(CharSequence text, View.OnClickListener listener) {
            if (rightViewList == null) rightViewList = new ArrayList<>();
            rightViewList.add(createTextMenu(mContext, text, subTextColorId, listener));
            return this;
        }

        public Builder addRightText(CharSequence text, @ColorInt int textColorId, View.OnClickListener listener) {
            if (rightViewList == null) rightViewList = new ArrayList<>();
        ...
        public Builder addRightText(@StringRes int textResId, View.OnClickListener listener) {
            addRightText(mContext.getString(textResId), listener);
            return this;
        }

        public Builder addRightText(@StringRes int textResId, @ColorInt int textColorId, View.OnClickListener listener) {
    ...
    public static TextView createTextMenu(Context context, CharSequence text, @ColorInt int textColorId, View.OnClickListener listener) {
        return createTextMenu(context, text, textColorId, 18, listener);
    }

    public static TextView createTextMenu(Context context, CharSequence text, @ColorInt int textColorId, float textSize_SP, View.OnClickListener listener) {
    ...
    public static ImageView createImageMenu(Context context, @DrawableRes int imageResId, View.OnClickListener listener) {
